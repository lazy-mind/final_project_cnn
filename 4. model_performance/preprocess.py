...
class Preprocessor():
    ...
    def __init__(self, dict_path = "dict/glove_dict_minimum_all.txt", max_length_tweet=40, max_length_dictionary=4750600):
    ...
    def get_glove_dictionary(self, file_path="./glove.twitter.27B.25d.txt"):
        ...
        file = open("./glove_dict_minimum_all.txt", "a",encoding='utf-8')
        for word in keys:
            file.write(word + '\n')
        file.close()
